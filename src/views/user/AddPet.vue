<template>
  ...
  <div class="max-w-4xl mx-auto p-6 rounded-lg mb-12">
    ...
    <div class="container mx-auto py-28 px-4 mr-26 ml-26 bg-white rounded-xl shadow-lg shadow-black">
      ...
      <!-- Adding Pet Section -->
      <div class="mb-8">
        <h2 class="text-xl font-extrabold mb-4 ml-24 mr-24 text-teal-900">Fill up Pet Details</h2>
        <form @submit.prevent="submitPetDetails">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4 ">
            <div>
              <label for="type" class="block text-gray-700 font-bold mb-2">Type:</label>
              <input type="text" id="type" v-model="petDetails.type"
            ...
            <div>
              ...
              <select id="sex" v-model="petDetails.sex"
                class="w-full bg-indigo-100 rounded-full shadow-sm p-4 shadow-black focus:ring-blue-500 focus:border-blue-500" required>
          ...
          <div class="mb-8">
            <h2 class="text-xl font-extrabold mb-4 text-center text-teal-900">Upload up to 4 Vaccination Certificates</h2>
            <div class="relative border-2 border-dashed border-gray-400 p-6 rounded-xl bg-indigo-100 text-center">
        ...
        file:bg-teal-800 file:text-white">
          ...
          <div class="justify center text-center">
            ...
            <textarea id="description" v-model="petDetails.description"
              class="text-center border-gray-300 bg-indigo-100 rounded-xl shadow-sm shadow-black focus:ring-blue-500 focus:border-blue-500 py-6 p-16 w-full" rows="5"
              placeholder="Enter description here (required)" required></textarea>
          </div>
          <div class="text-center">
      <button type="submit"
            class="bg-teal-800 text-white py-3 px-6 rounded-full hover:bg-blue-700 transition duration-300 ml-24 mr-24">Rehome this
            Pet</button>
      </div>
        </form>
      </div>
...
export default {
  ...
  try {
    await axios.post('http://localhost:3000/api/pets/pets', formData, {
      headers: {
