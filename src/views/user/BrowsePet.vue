<template>
  <div class="min-h-screen mt-24">
    ...
    <div class="bg-teal-50 flex flex-col md:flex-row items-center justify-center text-center py-12">
      <div class="flex flex-col md:flex-row items-center justify-center text-center">
        <div data-aos="fade-up">
          <h1 class="text-3xl sm:text-3xl font-extrabold mb-2 text-teal-800"data-aos="fade-left">
            Adopt a Pet.
          </h1>
          <h2 class="text-4xl sm:text-5xl font-extrabold mb-2 text-gray-700"data-aos="fade-right">
            Find the right friend
          </h2>
          <h2 class="text-4xl sm:text-5xl font-extrabold mb-12 md:mb-0 text-orange-500"data-aos="fade-right">for you.</h2>
          <div class="mt-16"></div>
        </div>
    ...
    <div class="px-5 py-6"data-aos="fade-up">
      ...
      <div class="container mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
          <div v-for="pet in pets" :key="pet.id" data-aos="fade-up" class="animate-fade-in relative bg-white shadow-lg shadow-black border border-gray-300 rounded-lg overflow-hidden 
