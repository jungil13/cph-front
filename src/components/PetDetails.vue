      ...
      <div class="md:col-span-2 bg-white p-6 shadow-lg shadow-black rounded">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <p class="text-xl font-bold mb-4">Current Owner: <span class="text-teal-700 p-1 cursor-pointer"
...
export default {
  ...
  methods: {
    ...
    async fetchUserDetails(ownerId) {
      try {
        const response = await axios.get(`http://localhost:3000/api/users/${ownerId}`, {
          headers: {
