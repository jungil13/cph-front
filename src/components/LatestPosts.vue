<template>
    <div class="max-w-screen">
        <h2 class="text-4xl font-extrabold text-teal-900 mb-8 text-center"data-aos="fade-left">Latest Forum Posts</h2>
        ...
        <div v-else
            ...
            <div v-for="post in posts" :key="post.PostID" data-aos="fade-up"
