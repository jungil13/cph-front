...
export default {
    ...
    methods: {
        async fetchReports() {
            try {
                const response = await axios.get('http://localhost:3000/api/my-reports', {
                    headers: {
        ...
        async updateReportDetails() {
            ...
            try {
                await axios.patch(`http://localhost:3000/api/my-reports/${this.selectedReport.ReportID}`, formData, {
                    headers: {
                        Authorization: `Bearer ${localStorage.getItem('token')}`,
        ...
        deleteReport(report) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    axios.delete(`http://localhost:3000/api/reports/${report.ReportID}`, {
                        headers: {
                            Authorization: `Bearer ${localStorage.getItem('token')}`
                        }
                    })
