<template>
  <LostFound />
  <div class="max-w-5xl mx-auto bg-white border border-gray-900 p-6 rounded-lg shadow-lg shadow-black">
    <h1 class="text-3xl font-extrabold mb-6 text-center text-gray-700 font-sans">Report Lost or Found Pet</h1>
    <form @submit.prevent="submitReport" enctype="multipart/form-data">
      <!-- Report Type Selection -->
      <div class="mb-5">
        <label for="report-type" class="block text-gray-700 font-semibold mb-2">Report Type</label>
      ...
      <div class="mb-5">
        <label for="last-seen-location" class="block text-gray-700 font-semibold mb-2">Last Seen or Found Location</label>
      ...
      <div class="mb-5">
        <label for="contact-info" class="block text-gray-700 font-semibold mb-2">Your Contact Information</label>
      ...
      <!-- Photo Upload Input -->
      <div class="mb-5">
        <label for="photo" class="block text-gray-700 font-semibold mb-2">Upload Photos (Max 4)</label>
        <input type="file" id="photo" @change="handleFileUpload" multiple class="file:bg-indigo-500 file:border-0 file:rounded file:text-white file:px-4 file:py-2 cursor-pointer focus:outline-none focus:ring-2 focus:ring-indigo-500">
      ...
      <div class="text-center mt-6">
        <button type="submit" class="bg-indigo-600 text-white font-semibold py-2 px-8 rounded-lg shadow-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-700">
          Submit Report
        </button>
      </div>
    </form>
...
export default {
  ...
  methods: {
    submitReport() {
      ...
      axios.post('http://localhost:3000/api/reports', formData, {
        headers: {
